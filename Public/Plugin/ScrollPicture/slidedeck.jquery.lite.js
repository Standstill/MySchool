    ...
    window.SlideDeck = function(el,opts){
        ...
        var buildDeck = function(){
            ...
            for(var i=0; i<self.slides.length; i++){
                ...
                self.slide_width = (slide_width - sPad.left - sPad.right - sBorder.left - sBorder.right + 70);
                
                slide.css({
                    position: 'absolute',
                    left: offset,
                    zIndex: 1,
                    height: (height - sPad.top - sPad.bottom - sBorder.top - sBorder.bottom + 20) + "px",
                ...
                if (self.options.hideSpines !== true) {
                    ...
                    var spineStyles = {
                        ...
                        display: 'block',
                        left: offset,
                        width: (height - spinePad.left - spinePad.right + 20) + "px",
